...
# 2. データローダーの作成
# データセットのファイルパスを指定
# csv_file = './videos/1050/dataset_30000.csv'   #データ数30000
csv_file = '../dataset/dataset_train_scene1.csv'   #データ数10000
dataset = CustomDataset(csv_file)
dataloader = DataLoader(dataset, batch_size=128, shuffle=True)
# dataloader = DataLoader(dataset, batch_size=64, shuffle=True)

# model = PICNN_scene1(num_input, hidden_size_u, hidden_size_z, score_scaler = dataset.score_scaler)
model = PICNN_scene1(num_input, hidden_size_u, hidden_size_z)
# criterion = nn.MSELoss()   #回帰問題にはこれ
...
plt.legend()
plt.savefig("../graph/learning_loss_scene1.png")
plt.show()
...
csv_file = '../dataset/dataset_test_scene1.csv'   #データ数2000
# csv_file = './videos/1050/dataset_no_framerate_test.csv'   #データ数2000
...
plt.savefig("../graph/learning_result_scene1.png")
plt.show()

# 学習後、モデルの重みを保存する
torch.save(model.state_dict(), '../model/model_scene_1.pth')