...
# データセットのファイルパスを指定
csv_file = '../dataset/dataset_test_scene3.csv'   #データ数10000
...
plt.legend()
plt.savefig("../graph/learning_loss_scene3.png")
plt.show()
...
csv_file = '../dataset/dataset_test_scene3.csv'   #データ数2000
# csv_file = './videos/9470/dataset_no_framerate_test.csv'   #データ数10000
...
plt.savefig("../graph/learning_result_scene3.png")
plt.show()

# 学習後、モデルの重みを保存する
torch.save(model.state_dict(), '../model/model_scene_3.pth')